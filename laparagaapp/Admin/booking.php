      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="frmTmbhDataBooking" id="frmTmbhDataBooking" method="POST" action="action/SimpanDataBooking.php?id=<?php echo $rowBooking['Id_booking']; ?>" enctype="multipart/form-data">
                    <label style="display:block; text-align:left;">ID BOOKING</label>
                    <input type="text" name="txtId_booking" id="txtId_booking" class="form-control" value="<?php echo $rowBooking['Id_booking']; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">TANGGAL BOOKING</label>
                    <input type="date" name="txtTgl_booking" id="txtTgl_booking" class="form-control" value="<?php echo $rowBooking['Tgl_booking']; ?>" />
                    <br/>
                    <label style="display:block; text-align:left;">JAM MAIN</label>
                    <input type="text" name="txtJam_main" id="txtJam_main" class="form-control" value="<?php echo $rowBooking['jam_main']; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">durasi</label>
                    <input type="text" name="txtdurasi" id="txtdurasi" class="form-control" value="<?php echo $rowBooking['durasi']; ?>" />
                    <br/>
                    <label style="display:block; text-align:left;">ID LAPANGAN</label>
                    ...
                    <br>
                    <label style="display:block; text-align:left;">metode_pembayaran</label>
                    <select type="text" name="txtMetode_pembayaran" id="txtMetode_pembayaran" class="form-control" value="<?php echo $rowBooking['metode_bayar']; ?>" >
                    <option value="pilih">- Pilih -</option>
                    <option>transer bank</option>
                    <option>cash</option>
                  </select>
                    <br>
                    <label style="display:block; text-align:left;">bukti</label>
                    <input type="text" name="txtbukti" id="txtbukti" class="form-control" value="<?php echo $rowBooking['bukti_bayar']; ?>" />
                    <br>
                    <label style="display:block; text-align:left;">status</label>
